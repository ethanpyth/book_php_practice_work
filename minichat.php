...
<body>
    <form method="post" action="minichatpost.php">
        ...
        <label for="message">Message</label> : <input type="textarea" name="message" placeholder="Entrer votre message"> <br>
        <input type="submit">
    </form>
    <?php
        try {
        ...
        $reponse = $bdd->query('SELECT pseudo, message, HOUR() AS heure FROM minichat ORDER BY id limit 0, 10');
